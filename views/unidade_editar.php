        ...
        <div class="row" >
            <div class="col-sm-12 col-md-12 col-lg-12" id="pagina-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i class="fa fa-pencil"></i> Editar Unidade</li>
                </ol>
            </div>
        </div>
        <!--FIM pagina-header-->
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <form method="POST" autocomplete="off" id="form-unidade">
                    <input type="hidden" name="nCodUnidade" value="<?php echo $unidade['cod_unidade'] ?>"/>
                        ...
                        <article class="panel-body">
                            <div class="row">
                                <div class="col-sm-8 col-md-8 col-lg-8 form-group">
                                    ...
                                    <select name="nOrgao" id="iOrgao" class="form-control">
                                        ...
                                        foreach ($orgaos as $orgao) {
                                            if (!empty($unidade['nome_orgao']) && $unidade['cod_orgao'] == $orgao['cod_orgao']) {
                                ...
                                <div class="form-group col-sm-4 col-md-4 col-lg-4">
                                    ...
                                    <select name="nCidade" id="iCidade" class="form-control" onchange="selectCidade()">
                                        ...
                                        foreach ($cidades as $resultado) {
                                            if (!empty($unidade['cod_area_atuacao']) && $unidade['cod_area_atuacao'] == $resultado['cod_area_atuacao']) {
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-12 form-group <?php echo (isset($unidade_erro['nome']['class'])) ? $unidade_erro['nome']['class'] : ''; ?>">
                                    ...
                                    <input type="text" name="nUnidade" id="iUnidade" class="form-control" placeholder="Exemplo: Fórum Desembargador Walter Bezerra Falcão" value="<?php echo (!empty($unidade['nome_unidade'])) ? $unidade['nome_unidade'] : ''; ?>">
                                </div>
                                <div class="col-md-4 form-group ">
                                    ...
                                    <select name="nConexao" id="iConexao" class="form-control">
                                        ...
                                        for ($qtd = 1; $qtd <= count($conexao); $qtd++) {
                                            if (!empty($unidade['conexao_unidade']) && $unidade['conexao_unidade'] == $conexao[$qtd]) {
                                ...
                                <div class="col-md-4 form-group" id="list_ap">
                                    ...
                                    <?php echo (!empty($unidade['cod_ap'])) ? '<script>var selectAp = ' . $unidade["cod_ap"] . '</script>' : '<script>var selectAp = null</script>' ?>
                                ...
                                <div class="col-md-4 form-group " id="list_redemetro">
                                    ...
                                    <?php echo (!empty($unidade['cod_redemetro'])) ? '<script>var selectRedMetro = ' . $unidade["cod_redemetro"] . '</script>' : '<script>var selectRedMetro = null</script>' ?>
                                ...
                                <div class="col-md-4 form-group <?php echo (isset($unidade_erro['ip']['class'])) ? $unidade_erro['ip']['class'] : ''; ?>">
                                    ...
                                    <input type="text" name="nIP" id="iIP" class="form-control" placeholder="Exemplo: 10.87.24.1"  value="<?php echo (!empty($unidade['ip_unidade'])) ? $unidade['ip_unidade'] : ''; ?>">
                                </div>
                                ...
                                <div class="col-md-4 form-group <?php echo (isset($unidade_erro['vlan']['class'])) ? $unidade_erro['vlan']['class'] : ''; ?>">
                                    ...
                                    <input type="text" name="nVLAN" id="iVLAN" class="form-control" placeholder="Exemplo: inf_propazdorothy" value="<?php echo (!empty($unidade['nome_vlan_unidade'])) ? $unidade['nome_vlan_unidade'] : ''; ?>">
                                </div>
                                ...
                                <div class="col-md-4 form-group <?php echo (isset($unidade_erro['tag_vlan']['class'])) ? $unidade_erro['tag_vlan']['class'] : ''; ?>">
                                    ...
                                    <input type="text" name="nTagVlan" id="iTagVlan" class="form-control" placeholder="Exemplo: 67" maxlength="5" value="<?php echo (!empty($unidade['tag_vlan_unidade'])) ? $unidade['tag_vlan_unidade'] : ''; ?>">
                                </div>
                                ...
                                <div class="col-md-4 form-group <?php echo (isset($unidade_erro['banda']['class'])) ? $unidade_erro['banda']['class'] : ''; ?>">
                                    ...
                                    <input type="text" name="nBanda" id="iBanda" class="form-control" placeholder="Exemplo: 4 Mb" value="<?php echo (!empty($unidade['banda_unidade'])) ? $unidade['banda_unidade'] : ''; ?>">
                                </div>
                                ...
                                <div class="col-md-4 form-group <?php echo (isset($unidade_erro['statu']['class'])) ? $unidade_erro['statu']['class'] : ''; ?>">
                                    ...
                                    <input type="text" name="nStatus" id="iStatus" class="form-control" placeholder="Exemplo: Ativo" value="<?php echo (!empty($unidade['statu_unidade'])) ? $unidade['statu_unidade'] : ''; ?>">
                                </div>
                                ...
                                <div class="col-md-4 form-group <?php echo (isset($unidade_erro['data']['class'])) ? $unidade_erro['data']['class'] : ''; ?>">
                                    ...
                                    <input type="text" name="nDataAtivacao" id="inDataAtivacao" class="form-control input-date" maxlength="10" placeholder="Exemplo: 20/03/2009" value="<?php echo (!empty($unidade['data_ativacao_unidade'])) ? $unidade['data_ativacao_unidade'] : ''; ?>">
                                </div>
                                <div class="col-md-4   form-group ">
                                    <label for="iZabbix" class="control-label">Zabbix:</label>
                                    <input type="text" name="nZabbix" id="iZabbix" class="form-control" placeholder="Exemplo: Cadastrado" value="<?php echo (!empty($unidade['zabbix_unidade'])) ? $unidade['zabbix_unidade'] : ''; ?>">
                                </div>
                                <div class="col-md-8  form-group">
                                    <label for="iUrlZabbix" class="control-label">Url no Zabbix: </label>
                                    <input type="text" name="nUrlZabbix" id="iUrlZabbix" class="form-control" placeholder="Exemplo: http://zabbix.prodepa.pa.gov.br/zabbix/charts.php?form_refresh=1&fullscreen=1&groupid=0&hostid=14022&graphid=0" value="<?php echo (!empty($unidade['url_zabbix_unidade'])) ? $unidade['url_zabbix_unidade'] : ''; ?>">
                                </div>
                            </div> <!-- fim row-->
                        </article>
                                    ...
                                    foreach ($unidade['contratos'] as $contrato) :
                                        ...
                                        <div id="contrato_<?php echo $qtdContrato ?>" class="row container_cad_contrato">
                                            ...
                                            <div class="col-md-8 form-group">
                                                ...
                                                <select id="iTipoContratro<?php echo $qtdContrato ?>" name="nTipoContratro<?php echo $qtdContrato ?>" class="form-control">
                                                    ...
                                                    for ($qtd = 1; $qtd <= count($tipoContrato); $qtd++) {
                                                        if ($contrato['nome_contrato'] == $tipoContrato[$qtd]) {
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="date" name="nDataInicial<?php echo $qtdContrato ?>" id="iDataInicial1" class="form-control input-date" placeholder="Exemplo: 20/05/2011" value="<?php echo $contrato['data_inicial_contrato'] ?>">
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="iDataVigencia<?php echo $qtdContrato ?>">Data de Vigência:</label>
                                                <input type="date" name="nDataVigencia<?php echo $qtdContrato ?>" id="iDataVigencia<?php echo $qtdContrato ?>" class="form-control input-date" placeholder="Exemplo: 20/06/2014" value="<?php echo $contrato['data_vigencia_contrato'] ?>">
                                            </div>
                                        </div>
                                        <?php
                                        --$qtdContrato;
                        ...
                        <article class="panel-body">
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="hidden" name="nCodEndereco" value="<?php echo (!empty($unidade['endereco']['cod_endereco'])) ? $unidade['endereco']['cod_endereco'] : ''; ?>">
                                    <input type="text" name="nLogradouro" id="iLogradouro" class="form-control" placeholder="Exemplo: Tv. Quinze de Agosto" value="<?php echo (!empty($unidade['endereco']['logradouro_endereco'])) ? $unidade['endereco']['logradouro_endereco'] : ''; ?>">
                                </div>
                                <div class="col-md-2 form-group">
                                    <label for="iNumero">Número:</label>
                                    <input type="text" name="nNumero" id="iNumero" class="form-control" placeholder="Exemplo: 100 ou S/N" value="<?php echo (!empty($unidade['endereco']['numero_endereco'])) ? $unidade['endereco']['numero_endereco'] : ''; ?>">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label for="iBairro">Bairro:</label>
                                    <input type="text" name="nBairro" id="iBairro" class="form-control" placeholder="Exemplo: Bela Vista" value="<?php echo (!empty($unidade['endereco']['bairro_endereco'])) ? $unidade['endereco']['bairro_endereco'] : ''; ?>">
                                </div>
                                <div class="col-md-12 form-group">
                                    <label for="iComplemento">Complemento:</label>
                                    <input type="text" name="nComplemento" id="iComplemento" class="form-control" placeholder="Exemplo: Próximo ao Mercantil Alvorada" value="<?php echo (!empty($unidade['endereco']['complemento_endereco'])) ? $unidade['endereco']['complemento_endereco'] : ''; ?>">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label for="iLatitude">Latitude:</label>
                                    <input type="text" name="nLatitude" id="iLatitude" class="form-control" placeholder="Exemplo: -4.2587258" value="<?php echo (!empty($unidade['endereco']['latitude_endereco'])) ? $unidade['endereco']['latitude_endereco'] : ''; ?>">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label for="iLongitude">Longitude:</label>
                                    <input type="text" name="nLongitude" id="iLongitude" class="form-control" placeholder="Exemplo: -55.998460" value="<?php echo (!empty($unidade['endereco']['longitude_endereco'])) ? $unidade['endereco']['longitude_endereco'] : ''; ?>">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label for="iGPS">GPS: </label>
                                    <input type="text" name="nGPS" id="iGPS" class="form-control" placeholder="Exemplo: 04°16’32.80’’S, 55°59’07.70’’W" value='<?php echo (!empty($unidade["endereco"]["gps_endereco"])) ? $unidade["endereco"]["gps_endereco"] : ""; ?>'>
                                </div>
                                ...
                                <script>
                                var getLatitude = <?php echo (!empty($unidade['endereco']['latitude_endereco'])) ? $unidade['endereco']['latitude_endereco'] : 'null'; ?>;
                                var getLongitude = <?php echo (!empty($unidade['endereco']['longitude_endereco'])) ? $unidade['endereco']['longitude_endereco'] : 'null'; ?>;
                                </script>
                            </div>
                        </article>
                                ...
                                if (!empty($unidade['contatos'])) {
                                    ...
                                    foreach ($unidade['contatos'] as $contato) :
                                        ...
                                        <div id="contato_<?php echo $qtdContato ?>" class="row container_cad_contato">
                                            <?php if(isset($contato['cod_contato'])): ?>
                                            <input type="hidden" name="nCodContato<?php echo $qtdContato ?>" value="<?php echo (!empty($contato['cod_contato'])) ? $contato['cod_contato'] : ""; ?>">
                                            <?php endif; ?>
                                            <hr/>
                                            <div class="col-md-6 form-group">
                                                <label for="iNome<?php echo $qtdContato ?>">Nome:</label>
                                                <input type="text" name="nNome<?php echo $qtdContato ?>" id="iNome<?php echo $qtdContato ?>" class="form-control" placeholder="Exemplo: Joab Alencar" value="<?php echo (!empty($contato['nome_contato'])) ? $contato['nome_contato'] : ""; ?>">
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="iEmail<?php echo $qtdContato ?>">E-mail:</label>
                                                <input type="email" name="nEmail<?php echo $qtdContato ?>" id="iEmail<?php echo $qtdContato ?>" class="form-control" placeholder="Exemplo: usuario@live.com" value="<?php echo (!empty($contato['email_contato'])) ? $contato['email_contato'] : ""; ?>">
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="iTelefone1_<?php echo $qtdContato ?>">Telefone:</label>
                                                <input type="text" name="nTelefone1_<?php echo $qtdContato ?>" id="iTelefone1_<?php echo $qtdContato ?>" class="form-control input-telefone" placeholder="Exemplo: (93) 3518-0011" value="<?php echo (!empty($contato['telefone1_contato'])) ? $contato['telefone1_contato'] : ""; ?>">
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="iTelefone2_<?php echo $qtdContato ?>">Celular:</label>
                                                <input type="text" name="nTelefone2_<?php echo $qtdContato ?>" id="iTelefone2_<?php echo $qtdContato ?>1" class="form-control input-celular" placeholder="Exemplo: (093) 99222-3333" value="<?php echo (!empty($contato['telefone2_contato'])) ? $contato['telefone2_contato'] : ""; ?>">
                                            </div>
                                        </div>
                                        <?php
                                        --$qtdContato;

            ...
            <div class="col-xs-12">
                <div class="panel-group" id="accordion">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#apresentacao">
                                    <i class="fa fa-share"></i> 1. Apresentação
                                </a>
                            </h4>
                        </div>
                        <div id="apresentacao" class="panel-collapse collapse in">
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                                    <i class="fa fa-share"></i> 2. Relatorios
                                </a>
                            </h4>
                        </div>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree123">
                                    <i class="fa fa-share"></i> 3. Usuários
                                </a>
                            </h4>
                        </div>
                        <div id="collapseThree123" class="panel-collapse collapse">
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-xs-12">
                                      <h4 class="text-center">1.1 Introdução</h4>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
                                    <i class="fa fa-share"></i> 4. Cadastros
                                </a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree1">
                                    <i class="fa fa-share"></i> 5. Edições
                                </a>
                            </h4>
                        </div>
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree2">
                                    <i class="fa fa-share"></i>  6.  Exclusões
                                </a>
                            </h4>
                        </div>

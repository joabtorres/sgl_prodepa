...
class relatorioController extends controller {
     ...
     * @author Joab Torres <joabtorres1508@gmail.com>
     */
    public function unidades($page = array(), $cod_cidade = array()) {
        ...
        if (empty($cod_cidade)) {
            ...
            $resultado_cidade = $cidadeModel->read("SELECT DISTINCT(sgl_cidade_area_atuacao.cidade_area_atuacao) FROM sgl_ap, sgl_unidade, sgl_cidade_area_atuacao, sgl_cidade_nucleo WHERE sgl_ap.cod_ap=sgl_unidade.cod_ap AND sgl_unidade.cod_cidade=sgl_cidade_area_atuacao.cod_area_atuacao AND sgl_cidade_area_atuacao.cod_nucleo=sgl_cidade_nucleo.cod_nucleo AND sgl_cidade_nucleo.cod_nucleo=:cod_nucleo ORDER BY sgl_cidade_area_atuacao.cidade_area_atuacao ASC", $data);

            //total de registros
            $unidadeModel->read("SELECT sgl_ap.nome_ap,sgl_ap.cod_ap, sgl_cidade_area_atuacao.cidade_area_atuacao, sgl_unidade.cod_unidade, sgl_unidade.nome_unidade FROM sgl_ap, sgl_unidade, sgl_cidade_area_atuacao, sgl_cidade_nucleo WHERE sgl_ap.cod_ap=sgl_unidade.cod_ap AND sgl_unidade.cod_cidade=sgl_cidade_area_atuacao.cod_area_atuacao AND sgl_cidade_area_atuacao.cod_nucleo=sgl_cidade_nucleo.cod_nucleo AND sgl_cidade_nucleo.cod_nucleo=:cod_nucleo ORDER BY sgl_cidade_area_atuacao.cidade_area_atuacao ASC, sgl_ap.nome_ap ASC, sgl_unidade.nome_unidade ASC", $data);
            $total_registro = $unidadeModel->getNumRows();
        } else {
            $data['cod_cidade'] = addslashes($cod_cidade);
            $dados['cod_cidade'] = addslashes($cod_cidade);
            $resultado_unidade = $unidadeModel->read("SELECT sgl_ap.nome_ap,sgl_ap.cod_ap, sgl_cidade_area_atuacao.cidade_area_atuacao, sgl_unidade.cod_unidade, sgl_unidade.nome_unidade FROM sgl_ap, sgl_unidade, sgl_cidade_area_atuacao, sgl_cidade_nucleo WHERE sgl_ap.cod_ap=sgl_unidade.cod_ap AND sgl_unidade.cod_cidade=sgl_cidade_area_atuacao.cod_area_atuacao AND sgl_cidade_area_atuacao.cod_nucleo=sgl_cidade_nucleo.cod_nucleo AND sgl_cidade_nucleo.cod_nucleo=:cod_nucleo AND sgl_cidade_area_atuacao.cod_area_atuacao=:cod_cidade ORDER BY sgl_cidade_area_atuacao.cidade_area_atuacao ASC, sgl_ap.nome_ap ASC, sgl_unidade.nome_unidade ASC LIMIT " . $indice . "," . $limite, $data);
            $resultado_cidade = $cidadeModel->read("SELECT DISTINCT(sgl_cidade_area_atuacao.cidade_area_atuacao) FROM sgl_ap, sgl_unidade, sgl_cidade_area_atuacao, sgl_cidade_nucleo WHERE sgl_ap.cod_ap=sgl_unidade.cod_ap AND sgl_unidade.cod_cidade=sgl_cidade_area_atuacao.cod_area_atuacao AND sgl_cidade_area_atuacao.cod_nucleo=sgl_cidade_nucleo.cod_nucleo AND sgl_cidade_nucleo.cod_nucleo=:cod_nucleo AND sgl_cidade_area_atuacao.cod_area_atuacao=:cod_cidade ORDER BY sgl_cidade_area_atuacao.cidade_area_atuacao ASC", $data);
        ...
        foreach ($resultado_cidade as $cidade) {
            $qtdAp = 0;
            $resultado[$qtdCidade] = array('cidade' => $cidade['cidade_area_atuacao'], 'aps' => array());
            foreach ($resultado_ap as $ap) {
                $qtdUnidade = 0;
                $resultado[$qtdCidade]['aps'][$qtdAp] = array('nome_ap' => $ap['nome_ap'], 'cod_ap' => $ap['cod_ap'], 'unidades' => array());
                foreach ($resultado_unidade as $unidade) {
                    if ($cidade['cidade_area_atuacao'] == $unidade['cidade_area_atuacao'] && $ap['cod_ap'] == $unidade['cod_ap']) {
                        $resultado[$qtdCidade]['aps'][$qtdAp]['unidades'][$qtdUnidade] = array('nome_unidade' => $unidade['nome_unidade'], 'cod_unidade' => $unidade['cod_unidade']);
                    }
                    $qtdUnidade = $qtdUnidade + 1;
                }
                $qtdAp = $qtdAp + 1;

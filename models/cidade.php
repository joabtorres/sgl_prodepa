...
/**
 * A classe 'cidade' é responsável para efetiva comandos sql no banco de dados, como, insert, update, select, delete, count;
 * 
...
class cidade extends model {
    ...
    /**
     * Está função é responsável para cadastrar novas cidades;
